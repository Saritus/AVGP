================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: Pixelgrafiken-Projektübersicht
===============================================================================

Diese Pixelgrafiken-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Pixelgrafiken-Anwendung besteht.

Pixelgrafiken.vcxproj
...
Pixelgrafiken.h
    ...
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CPixelgrafikenApp-Anwendungsklasse.

Pixelgrafiken.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CPixelgrafikenApp enthält.
...
res\Pixelgrafiken.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei Pixelgrafiken.rc enthalten.

res\Pixelgrafiken.rc2
...
PixelgrafikenDlg.h, PixelgrafikenDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CPixelgrafikenDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in Pixelgrafiken.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Pixelgrafiken.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
