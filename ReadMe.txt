================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: MCI-Anwendungen-Projektübersicht
===============================================================================

Diese MCI-Anwendungen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre MCI-Anwendungen-Anwendung besteht.

MCI-Anwendungen.vcxproj
...
MCI-Anwendungen.vcxproj.filters
...
MCI-Anwendungen.h
    ...
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CMCIAnwendungenApp-Anwendungsklasse.

MCI-Anwendungen.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CMCIAnwendungenApp enthält.
...
res\MCI-Anwendungen.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei MCI-Anwendungen.rc enthalten.

res\MCIAnwendungen.rc2
...
MCI-AnwendungenDlg.h, MCI-AnwendungenDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CMCIAnwendungenDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in MCI-Anwendungen.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen MCI-Anwendungen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
