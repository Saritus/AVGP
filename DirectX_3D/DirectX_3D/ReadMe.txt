================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: DirectX_3D-Projektübersicht
===============================================================================

Diese DirectX_3D-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre DirectX_3D-Anwendung besteht.
...
DirectX_3D.h
    ...
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CDirectX_3DApp-Anwendungsklasse.

DirectX_3D.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CDirectX_3DApp enthält.
...
res\DirectX_3D.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei DirectX_3D.rc enthalten.
...
DirectX_3DDlg.h, DirectX_3DDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CDirectX_3DDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in DirectX_3D.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen DirectX_3D.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
